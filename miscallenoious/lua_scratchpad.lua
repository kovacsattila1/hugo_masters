...
function sysCall_init() 
    ...
    --sim.setJointTargetForce(rightLegJoint2, val[1], true)
    --sim.setJointTargetForce(rightLegJoint3, val[2], true)
    --sim.setJointTargetForce(rightLegJoint4, val[3], true)
    --sim.setJointTargetForce(rightLegJoint5, val[4], true)
    --sim.setJointTargetForce(rightLegJoint6, val[5], true)
    --sim.setJointTargetForce(leftLegJoint1, val[6], true)
    --sim.setJointTargetForce(leftLegJoint2, val[7], true)
    --sim.setJointTargetForce(leftLegJoint3, val[8], true)
    --sim.setJointTargetForce(leftLegJoint4, val[9], true)
    --sim.setJointTargetForce(leftLegJoint5, val[10], true)
    --sim.setJointTargetForce(leftLegJoint6, val[11], true)
    --sim.setJointTargetForce(neckJoint1, val[12], true)
    --sim.setJointTargetForce(neckJoint2, val[13], true)
    --sim.setJointTargetForce(leftArmJoint1, val[14], true)
    --sim.setJointTargetForce(leftArmJoint2, val[15], true)
    --sim.setJointTargetForce(leftArmJoint3, val[16], true)
    --sim.setJointTargetForce(rightArmJoint1, val[17], true)
    --sim.setJointTargetForce(rightArmJoint2, val[18], true)
    --sim.setJointTargetForce(rightArmJoint3, val[19], true)
    --sim.setJointTargetForce(rightLegJoint1, val[20], true)
