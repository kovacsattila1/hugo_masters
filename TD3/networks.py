...
class CriticNetwork(nn.Module):
    def __init__(self, id, beta, input_dims, fc1_dims, fc2_dims, fc3_dims, n_actions, name, chkpt_dir='tmp/td3'):
        ...
        self.checkpoint_file = os.path.join(self.checkpoint_dir, name + '_td3' + '_fc1' + str(self.fc1_dims) + '_fc2' + str(self.fc2_dims) + '_fc3' + str(self.fc3_dims)  + '_' +str(id))
