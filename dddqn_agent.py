...
class DuelingDeepQNetwork(keras.Model):
  def __init__(self, n_actions, fc1_dims, fc2_dims): #fc- fully connected
...
class Agent():
  def __init__(self, lr, gamma, n_actions, epsilon, batch_size, input_dims, epsilon_dec=1e-3, eps_end=0.01, mem_size=1000000, fc1_dims=128, fc2_dims=128, replace=100):
  ...
  #   self.q_next = keras.models.load_model('./dddqn_agent.q_next', custom_objects={"DuelingDeepQNetwork": DuelingDeepQNetwork})
